...
def parse_arguments():
  ...
  parser.add_argument('-e', '--evaluate', help="evaluate model", action='store_true')
  parser.add_argument('-s', '--search', help="search architectures", action='store_true')
  parser.add_argument('-o', '--optimize', help="optimization model", action='store_true')
  parser.add_argument('-b', '--benchmark', help="Benchmark model", action='store_true')
